    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == frmPassword.btnGuardar) {
            ...
            if(passwordActual.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe capturar un valor para el campo Contraseña Actual.", "Error", JOptionPane.ERROR_MESSAGE);
                frmPassword.txtPasswordActual.grabFocus();
            }
            else if(passwordNuevo1.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe capturar un valor para el campo Contraseña Nueva.", "Error", JOptionPane.ERROR_MESSAGE);
                frmPassword.txtPasswordNuevo1.grabFocus();
            }
            else if(passwordNuevo2.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe capturar un valor para el campo Confirmar Contraseña Nueva.", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                String passwordCifrado = hash.md5(passwordNuevo1);
