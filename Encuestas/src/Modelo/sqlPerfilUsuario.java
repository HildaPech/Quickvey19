...
public class sqlPerfilUsuario extends ConexionBD {
    public boolean registrarPerfilUsuario(PerfilUsuario perfil) {
        ...
        String sql = "INSERT INTO tbl_rel_perfilesusuarios (iIdUsuario, iIdPerfil, lActivo, dtAlta, dtModificacion) VALUES (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            ps.setInt(3, perfil.getActivo());
            ps.setString(4, perfil.getAlta());
            ps.setString(5, perfil.getModificacion());
