...
public class RespuestaEncuestaRealizada {
    ...
    public RespuestaEncuestaRealizada() {
    ...
    public RespuestaEncuestaRealizada(int iIdEncuestaRealizada, int iIdPregunta, int iIdRespuesta, int lActivo, String dtAlta, String dtModificacion) {
